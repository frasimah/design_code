...
ANALYSIS_PROMPT = """Проанализируй изображение кирпича и опиши его характеристики для поиска в каталоге.

Опиши:
1. Цвет (основной цвет, оттенки, наличие нюансов/подпалин)
2. Текстура (гладкая, шероховатая, рваная, water-struck, ручная формовка)
3. Ровность поверхности (от 1 до 10)
4. Визуальный стиль (современный, лофт, антик, рустикальный, индустриальный)

Верни JSON:
{
    "color_description": "описание цвета...",
    "texture_description": "описание текстуры...",
    "smoothness_score": 5,
    "style_tags": ["лофт", "состаренный"],
    "search_query": "короткий запрос для поиска в каталоге, например: красный кирпич ручной формовки с нюансами"
}
"""
